...
# mnist = input_data.read_data_sets("data/FashionMNIST/")
...
# batch_size = None
X = tf.Variable(tf.zeros([batch_size, n_steps, n_inputs], dtype=tf.float32))
y = tf.Variable(tf.zeros([batch_size], dtype=tf.int32))
